-- ============================================
-- MIGRATION: Fix Daily Questions EST Timezone
-- ============================================
-- Changes the daily question reset time from UTC midnight to 12AM EST/EDT
-- Uses America/New_York timezone which handles DST automatically

-- ============================================
-- STEP 1: Update get_todays_question to use EST timezone
-- ============================================
...
-- Add a comment documenting the timezone behavior
COMMENT ON FUNCTION get_todays_question IS 'Gets or creates today''s question for a couple. Uses America/New_York (EST/EDT) timezone, resetting at midnight Eastern Time.';
