...
async function retrieveHistoricalContext(caseData) {
    ...
    try {
        ...
        // Step 1: Generate query embedding from case inputs
        ...
        // Step 2: Fetch static profiles for both users (in parallel)
        console.log('[Memory Retrieval] Fetching user profiles...');
