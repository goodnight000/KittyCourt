                    ...
                    <form onSubmit={handleEmailSignUp} className="space-y-4">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-12 pr-4 py-3.5 bg-neutral-50 border rounded-2xl text-neutral-700 placeholder:text-neutral-400 focus:outline-none focus:ring-2 transition-all ${
